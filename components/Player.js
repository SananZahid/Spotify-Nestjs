...
import { FastForwardIcon, PauseIcon, PlayIcon, RewindIcon, VolumeUpIcon as VolumeUpIconSolid, VolumeOffIcon as VolumeOffIconSolid} from '@heroicons/react/solid';
  ...
  return (
    <div className='h-24 bg-gradient-to-b from-black to-gray-900 text-white 
        ...
        <div className='flex items-center space-x-3 md:space-x-4 justify-end pr-5'>
            {volume === 0 ? (
                <VolumeOffIconSolid className='button' onClick={() => volume > 0 && setVolume(volume - 10)}/>
            ...
            {volume === 100 ? (
                <VolumeUpIconSolid className='button' onClick={() => volume < 100 && setVolume(volume + 10)} />
            ) : (
